...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(productName == "") {
				$("#productName").after('<p class="text-danger">Le champ Nom du produit est obligatoire</p>');
			...
			if(quantity == "") {
				$("#quantity").after('<p class="text-danger">Le champ Quantité est obligatoire</p>');
			...
			if(rate == "") {
				$("#rate").after('<p class="text-danger">Le champ Prix est obligatoire</p>');
			...
			if(brandName == "") {
				$("#brandName").after('<p class="text-danger">Le champ Marque est obligatoire</p>');
			...
			if(categoryName == "") {
				$("#categoryName").after('<p class="text-danger">Le champ Catégorie est obligatoire</p>');
		...
		$.ajax({
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					if(productName == "") {
						$("#editProductName").after('<p class="text-danger">Le champ Nom du produit est obligatoire</p>');
					...
					if(quantity == "") {
						$("#editQuantity").after('<p class="text-danger">Le champ Quantité est obligatoire</p>');
					...
					if(rate == "") {
						$("#editRate").after('<p class="text-danger">Le champ Prix est obligatoire</p>');
					...
					if(brandName == "") {
						$("#editBrandName").after('<p class="text-danger">Le champ Marque est obligatoire</p>');
					...
					if(categoryName == "") {
						$("#editCategoryName").after('<p class="text-danger">Le champ Catégorie est obligatoire</p>');
					...
					if(productStatus == "") {
						$("#editProductStatus").after('<p class="text-danger">Le champ Statut est obligatoire</p>');
