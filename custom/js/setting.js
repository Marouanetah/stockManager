$(document).ready(function() {
	...
	$("#changeUsernameForm").unbind('submit').bind('submit', function() {
		...
		if(username == "") {
			$("#username").after('<p class="text-danger">Le champ Nom utilisateur est obligatoire!</p>');
	...
	$("#changePasswordForm").unbind('submit').bind('submit', function() {
		...
		if(currentPassword == "" || newPassword == "" || conformPassword == "") {
			if(currentPassword == "") {
				$("#password").after('<p class="text-danger">Le champ Mot de passe actuel est requis!</p>');
			...
			if(newPassword == "") {
				$("#npassword").after('<p class="text-danger">Le champ Nouveau mot de passe est requis!</p>');
			...
			if(conformPassword == "") {
				$("#cpassword").after('<p class="text-danger">Le champ Confirmer le mot de passe est requis!</p>');
