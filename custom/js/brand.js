...
$(document).ready(function() {
	...
	$("#submitBrandForm").unbind('submit').bind('submit', function() {
		...
		if(brandName == "") {
			$("#brandName").after('<p class="text-danger">Le champ Nom de marque est obligatoire</p>');
		...
		if(brandStatus == "") {
			$("#brandStatus").after('<p class="text-danger">Le champ Statut de marque est obligatoire</p>');
		...
		$.ajax({
			...
			success:function(response) {
				...
				$('#editBrandForm').unbind('submit').bind('submit', function() {
					...
					if(brandName == "") {
						$("#editBrandName").after('<p class="text-danger">Le champ Nom de marque est obligatoire</p>');
					...
					if(brandStatus == "") {
						$("#editBrandStatus").after('<p class="text-danger">Le champ Nom de marque est obligatoire</p>');
