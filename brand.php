	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Gestion des marques</div>
			</div> <!-- /panel-heading -->
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitBrandForm" action="php_action/createBrand.php" method="POST">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><i class="fa fa-plus"></i> L'ajout d'une Marque</h4>
	      </div>
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Nom </label>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editBrandForm" action="php_action/editBrand.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-edit"></i> Modification d'une marque</h4>
	      </div>
	      <div class="modal-body">
	      ...
	      <div class="modal-footer editBrandFooter">
	        ...
	        <button type="submit" class="btn btn-success" id="editBrandBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Sauvegarder les modifications</button>
	      </div>
	      <!-- /modal-footer -->
     	</form>
	     <!-- /.form -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeMemberModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Suppression d'une Marque</h4>
      </div>
      <div class="modal-body">
